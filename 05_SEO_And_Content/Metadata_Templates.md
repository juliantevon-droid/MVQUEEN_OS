...
*Example: Building a morning skincare routine that actually works starts with knowing what your skin needs. Here's how to create a ritual you'll look forward to every day.*
...
|---------|--------|---------|
| Meta title | 50-55 characters | 60 characters |
| Meta description | 140-155 characters | 160 characters |
...
**Product pages:** `/products/[product-name-hyphenated]`
**Collection pages:** `/collections/[collection-name]`
**Blog articles:** `/blogs/news/[keyword-rich-title-hyphenated]`
