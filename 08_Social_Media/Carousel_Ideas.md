...
|-------|------|----------------|
| 1 — Cover | Stop the scroll | Hook in under 8 words. Curiosity gap or strong statement. |
| 2-3 | Open the loop | Introduce the tension or problem |
| 4-6 | Deliver value | The actual content — specific, useful, beautiful |
| 7 | Peak value | Best point saved for second-to-last |
| Last | Close + invite | Brand connection + soft CTA |

**Design rule:** One idea per slide. Short text. Consistent visual style throughout.

---

## Carousel Ideas by Content Pillar

### Pillar 1 — Softness & Identity
...
Slides: Signs of beauty as performance vs beauty as presence
Last: Permission statement + brand

---

### Pillar 2 — Education & Expertise
...
**"Your Complete [Product Name] Ritual"**
Cover: *The complete [product] ritual*
Slides: Step by step — how to get the most from the product
Last: Shop + related products

**"[Product Name] — Everything You Need to Know"**
Cover: *Everything you need to know about [product]*
...
## Caption Formula for Carousels

```
[Cover hook expanded — 1-2 sentences]
[What they'll find if they swipe — the promise]
Save this for when you're ready to [desired action].
[Hashtags]
```
