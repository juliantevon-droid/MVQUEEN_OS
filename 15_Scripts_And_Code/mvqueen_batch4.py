...
This folder is a legacy root-level directory. Active AI system content lives in:
...
This folder will be merged into the numbered system above. New AI files go into the appropriate numbered folder, not here.
""",
...
This folder is a legacy root-level directory. Active content system files live in:
...
New content files go into the appropriate numbered folder. This folder is kept for legacy reference only.
""",
...
| Email voice | `06_Tone_And_Voice/Email_Voice.md` |
...
This folder stores logo files and brand mark assets. Visual identity documentation lives in:
- `02_Brand_Identity/logo_guidelines.md` — usage rules
- `02_Brand_Identity/Logo_Concepts.md` — concept documentation
...
See `02_Brand_Identity/logo_guidelines.md` for full rules. Key points:
- Never stretch or distort the logo
- Maintain minimum clear space around the mark
- Do not place on busy backgrounds without a background blocker
...
❌ Stretch, squish, or rotate the logo
❌ Add drop shadows, outlines, or effects
❌ Place on busy photographic backgrounds without treatment
❌ Use unapproved color variations
❌ Use old or draft versions of the logo
...
This folder is a legacy root-level directory. Active Shopify system documentation lives in:
...
New Shopify files go into `09_Shopify_Systems/`. This folder is kept for any Shopify-specific raw exports or data files that need a holding location.
""",
...
- [ ] Tags applied
- [ ] Inventory tracked
- [ ] Shipping weight entered

---

## Key Shopify Metrics to Monitor
...
Tracks all batch operations run against the MVQUEEN_OS. Every batch is logged — date, scope, result, and file count.
...
| 2026-06-06 | Stub folder population — Batch 1 (12–19) | 18 | Completed |
| 2026-06-06 | Stub folder population — Batch 2 (21–29) | 18 | Completed |
| 2026-06-06 | Stub folder population — Batch 3 (30–39, 98) | 22 | Completed |
| 2026-06-06 | Root folder population — Batch 4 (AI, Content, Logos, Shopify, MVQUEEN_batch) | 10 | Completed |
