...
# ── 13_Scripts_And_Code (the second one — first is Research) ───────────────
"13_Scripts_And_Code/script_index.md": """# Script Index
...
"13_Scripts_And_Code/README.md": """# 13_Scripts_And_Code
## MVQUEEN_OS

Registry and documentation for all utility scripts powering MVQUEEN_OS operations. See `script_index.md` for full inventory.
""",
...
Production automation scripts for content, Shopify, SEO, and system operations. See `automation_scripts.md` for categories and standards.
""",
...
Automation architecture, workflow library, and deployment standards. Every automation preserves brand voice — speed never compromises quality.
""",
...
- Use `[BRACKETS]` for variable fields
- Include a voice note if tone variation is needed
- Be tested before adding to this library
...
[BODY — 2-3 lines expanding the hook, emotional or aspirational]
...
### Phase 3 — Rebuild + Populate 🔄
- Rebuilding ~40 contaminated files (in progress)
- Populating stub folders (in progress)
- Loose root folders decision pending

### Phase 4 — Shopify Integration (Planned)
- Shopify storefront audit
- Product description system deployment
- SEO meta system deployment
- App stack evaluation

### Phase 5 — AI + Automation (Planned)
- AI agent system build
- Prompt chain deployment
- Automation workflow activation
...
- Required for email/SMS collection
- Must be current and visible at checkout

### Terms of Service
- Required for Shopify store
- Must cover return/refund policy clearly
...
### Copyright
- All brand content, copy, and creative assets are original works
