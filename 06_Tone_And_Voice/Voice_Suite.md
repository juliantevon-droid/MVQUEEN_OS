...
**Framework:**
```
THE WORLD AS IT WAS → THE PROBLEM WE SAW → WHAT WE BELIEVED → WHAT WE BUILT → WHO WE BUILT IT FOR
```

---

### Story Type 02 — The Product Story
**What it is:** The origin, intention, and philosophy behind a specific product.
**Where it lives:** Product pages, launch emails, social content.
**Emotional goal:** Desire, trust, emotional connection to the object.

**Framework:**
```
WHY THIS PRODUCT EXISTS → HOW IT WAS MADE → WHAT MAKES IT DIFFERENT → THE WOMAN IT WAS MADE FOR → WHAT CHANGES WHEN SHE USES IT
```
...
**Framework:**
```
WHERE SHE WAS BEFORE → WHAT SHE FOUND → WHAT CHANGED → HOW SHE FEELS NOW
```

---

### Story Type 04 — The Philosophy Story
**What it is:** A piece of brand thinking told through narrative.
**Where it lives:** Blog, social captions, email brand content.
**Emotional goal:** Connection to values, belief, loyalty.
...
**Framework:**
```
THE BEFORE STATE (specific, relatable) → THE MOMENT OF ENCOUNTER → THE SHIFT → THE AFTER STATE (specific, sensory, real)
```
...
### Pillar 01 — Softness Is Strength
**Core message:** Choosing softness in a world that rewards hardness is a powerful act.
**Used for:** Brand content, campaign themes, manifesto-level copy.
**Example line:** *The world gets louder. She gets softer.*
...
### Pillar 03 — Beauty as Restoration
**Core message:** Beauty products and rituals should restore energy and identity — not perform perfection.
**Used for:** Product descriptions, campaign themes, educational content.
**Example line:** *Beauty that gives back what the day takes.*
...
These apply to every piece of content across every format and platform.

### Rule 01 — One Voice, Many Registers
The brand has one voice — warm, confident, feminine, intelligent.
...
The brand does not apologize for its positioning or its price.
The brand does not pressure women into purchases.
...
Luxury is restraint — in product and in language.
If a word doesn't add meaning, feeling, or clarity — cut it.

### Rule 06 — AI Content Always Gets Human Review
AI generates. Humans refine.
No AI output goes live without a brand voice check.

### Rule 07 — The Forbidden Word List Is Law
See `Forbidden_Words.md` — no exceptions without explicit approval.

### Rule 08 — Consistency Across Touchpoints
The product page, the email, the ad, and the packaging
should feel like they came from the same world.
If a customer moves between channels and the voice shifts dramatically — we've failed.
...
**Paragraphs:** Maximum 3-4 lines in digital copy. White space is luxury.

**Sentences:** Vary length intentionally.
Short sentences create power. Longer sentences create atmosphere. Use both.

**Headers:** Should work as standalone statements — not just labels.
❌ *Product Benefits* → ✅ *What Changes When She Uses It*

**Lists:** Use sparingly. When used, each item should be a complete thought — not a single word.

**Ellipsis:** Used only for intentional pause. Never as filler or to sound mysterious.

**Em dashes:** Use for dramatic pause or contrast. Maximum one per paragraph.

**Capitalization:** Proper nouns, brand name, product names. Never random capitalization for emphasis.

## Editing Checklist

Before any piece of copy is published:
```
□ Read it aloud — does it sound human?
□ First line — does it create a feeling immediately?
□ Any forbidden words? (Check Forbidden_Words.md)
□ Any word repeated more than twice? Remove one.
...
|---------|---------------|
| Calm | *Unhurried. Settled. Breathing room. Still.* |
| Confidence | *Grounded. Certain. Present. Ready.* |
| Desire | *Wants. Craves. Has been waiting for. Reaches for.* |
| Belonging | *Feels seen. Recognized. Made for her. Part of something.* |
| Restoration | *Comes back to herself. Feels like herself. Restored. Renewed.* |
| Luxury | *Unhurried. Intentional. Elevated. Worthy. Considered.* |
| Transformation | *Different now. Shifted. Becoming. Changed in ways she didn't expect.* |
...
*girly (as diminutive), pretty (as sole descriptor), dainty (implies fragility), just a girl, treat yourself (overused), queen (as generic flattery without meaning)*
...
| Specificity | *Skin that stays soft past 6pm* not *long-lasting hydration* |
| Sensory detail | *The weight of real cashmere* not *premium quality fabric* |
| Time and pace | *Unhurried. Considered. Made slowly.* |
| Confidence | State quality without defending it |
| Exclusivity (earned) | *Not for everyone. For her.* |
| Craftsmanship | *Made to last. Built on intention.* |
...
## Real Copy Examples by Format

### Product Description — Skincare
*She arrives in glass — because she deserves it.*
*[Product Name] is a serum that melts on contact, leaves no residue, asks nothing of you except a moment.*
*By morning, skin that looks like it slept well. By evening, skin you touch without thinking.*
*Use it last. Let her do the work.*

---

### Email Subject Lines (Ready to Use)
- *She's been a while coming.*
- *We made this for Tuesday mornings.*
...
### Instagram Captions (Ready to Use)
*The morning that belongs to her before it belongs to anyone else.*
*[Product Name] — in the link.*

---

*Soft things deserve to be chosen with intention.*
*Shop the ritual at the link in bio.*
...
- **Credible:** Truth behind every claim
